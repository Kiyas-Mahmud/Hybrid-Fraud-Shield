...
class APITester:
    ...
    def test_login_admin(self):
        ...
        result = self.make_request("POST", "/api/v1/auth/login", login_data, form_data=True)
    ...
    def test_submit_safe_transaction(self):
        ...
        result = self.make_request("POST", "/api/v1/transactions/submit", transaction_data, self.user_token)
    ...
    def test_unauthorized_transaction_access(self):
        ...
        result = self.make_request("GET", "/api/v1/transactions/")
    ...
    def test_mark_notification_read(self):
        ...
        result = self.make_request(
            "POST", 
            f"/api/v1/notifications/{self.test_notification_id}/read",
    ...
    def test_respond_to_transaction(self):
        ...
        result = self.make_request(
            "POST",
            f"/api/v1/transactions/{self.test_transaction_id}/respond",
            response_data,
            self.user_token
        )
    ...
    def test_admin_filter_transactions(self):
        ...
        result = self.make_request(
            "GET", 
            "/api/v1/admin/transactions?status=PENDING", 
    ...
    def test_admin_statistics(self):
        ...
        result = self.make_request("GET", "/api/v1/admin/dashboard/stats", token=self.admin_token)
    ...
    def test_admin_block_user(self):
        ...
        result = self.make_request(
            "POST",
            f"/api/v1/admin/users/{self.test_user_id}/block",
            block_data,
            self.admin_token
        )
